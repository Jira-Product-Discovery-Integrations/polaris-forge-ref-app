### Get Polaris Data Points Via API Reference Application Readme

We are providing ability to fetch data points from Polaris via Atlassian Graphql API.
...
8. On success you should be redirected to page with list of data points added to issue 🎉 .
